...
def remove_trios(args):
    ...
    retain_inds = np.where(~np.isin(np.arange(0, sampledata.num_individuals), remove_inds))[0]
...
def main():
    ...
    subparser.add_argument("trio_data", type=str, help="Path to file containing information of individuals in trios")
